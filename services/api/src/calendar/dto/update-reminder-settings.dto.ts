...
export class UpdateReminderSettingsDto {
  @ApiProperty({ required: false, description: 'Default reminder offset in minutes (e.g. 180 = 3 hours).' })
  @IsOptional()
  @IsInt()
  @Min(0)
  @Max(10080)
  ...
  @ApiProperty({ required: false, description: 'Quiet hours object, e.g. { start: "22:00", end: "07:00", tz: "America/Santo_Domingo" }' })
  @IsOptional()
  @IsObject()
